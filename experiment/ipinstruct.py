...
smalltrial = "Also, there are three different size fields you can be on \n \n Click the mouse to try an example with a small field"

largetrial = "Now you can click to try an example with a large field"
